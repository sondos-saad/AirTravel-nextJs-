  ...
  return (
    <section className='md:flex items-center justify-between py-10'>
      <div className='md:w-[50%]'>
        <h2 className='text-emerald-900 text-[35px] font-bold  mb-2'>Best Destinations around the world</h2>
        <p className='text-[70px] font-bold leading-20 '>Lorem ipsum, dolor sit amet consectetur adipisicing elit.</p>
